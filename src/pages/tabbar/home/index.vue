  ...
  <layout class="home">
    ...
    <view class="btn-group">
      <view class="btn-item" @click="routeto(item.url)" v-for="(item, index) in BtnItem" :key="index">
        <view v-if="item.svg != ''" style="height: 40px;" v-html="item.svg"></view>
    ...
    <view class="news">
      <u-cell-group v-if="list.length > 0" title="新闻" :customStyle="{ 'fontSize': '32rpx' }">
        ...
        <view>
          <u-button type="primary" style="width: 60vw;margin: 20rpx auto;" shape="circle"
            @click="moreNews">更多新闻</u-button>
        </view>
      </u-cell-group>
...
let BtnItem = reactive([
  ...
  {
    id: 2,
    svg: '<svg t="1726497317518" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="3500" width="40" height="40"><path d="M512 64C264.5 64 64 264.5 64 512s200.6 448 448 448 448-200.6 448-448S759.5 64 512 64z m-50.6 215.1h101.8c12.5 0 22.5 11.8 22.5 25.4 0 13.6-10 25.4-21.9 25.4H461.4c-12.5 0-22.5-11.8-22.5-25.4 0-13.7 10-25.4 22.5-25.4z m161.2 130.7c8.1 0 15 6.8 15 14.9 0 8.1-6.9 14.9-15 14.9H402.1c-8.1 0-15-6.8-15-14.9 0-8.1 6.9-14.9 15-14.9h220.5z m0 110.3H402.1c-8.1 0-15-6.8-15-14.9 0-8.1 6.9-14.9 15-14.9H622c8.1 0 15 6.2 15.6 14.9 0 8-6.9 14.9-15 14.9z m15 72.4c0 8.1-6.9 14.9-15 14.9H402.1c-8.1 0-15-6.8-15-14.9 0-8.1 6.9-14.9 15-14.9H622c8.1 0.1 14.9 6.3 15.6 14.9z m94.9 91.1c0 40.3-21.9 61.3-61.8 61.3H353.3c-40 0-61.8-25.4-61.8-61.3V352.2c0-33.4 17.5-58.8 58.7-58.8h36.9c8.1 0 11.2 5 11.2 13 0 8.1-3.1 16.1-11.2 16.1h-36.9c-17.5 0-29.4 11.8-29.4 29.1v335.1c0 17.3 19.4 29.1 36.9 29.1h316.1c17.5 0 29.4-11.8 29.4-29.1V351.6c0-17.3-11.9-29.1-29.4-29.1h-29.4c-8.1 0-17.5-8.1-17.5-16.1 0-8.1 9.4-13 17.5-13h29.4c38.1 0 58.7 25.4 58.7 58.8v331.4z" p-id="3501" fill="#60ADFC"></path></svg>',
    text: '交易明细',
